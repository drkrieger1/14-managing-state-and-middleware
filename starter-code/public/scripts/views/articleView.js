...
(function(module) {
  ...
  // This function is just rendering our article objects to the DOM via the handlebars template.
  // It is being called by the articleController to initiate the view of the articles.
